...
#' @export
rs_umap <- function(embd, n_dim, min_dist, spread, ann_type, optim, init, k, seed, verbose) .Call(wrap__rs_umap, embd, n_dim, min_dist, spread, ann_type, optim, init, k, seed, verbose)
