...
#>              s1          s2          s3          s4           s5
#> gs1  0.18184274  0.07564251 -0.15395305 -0.12772899 -0.189728149
#> gs2  0.01744525  0.17216938  0.11937192  0.10354503 -0.007774963
#> gs3 -0.08173283 -0.18560535  0.17464436  0.06376239  0.241252017
#> gs4  0.07434689 -0.24706135 -0.12711199  0.18944170  0.233555253
#> gs5  0.23737603  0.12688720  0.03460569  0.03557368 -0.017422807
```
...
#>      gsva 2492.8998 2499.6226 2510.7356 2506.3453 2519.6535 2532.9616     3
#>  bixverse  555.9449  555.9494  556.3591  555.9539  556.5662  557.1785     3
```
...
#>              s1          s2          s3            s4           s5
#> gs1 -0.19796139 -0.06388646  0.07364184  0.2290343630 -0.147546911
#> gs2  0.08667234  0.11522262 -0.11002315 -0.1441379240  0.053826137
#> gs3  0.20656923  0.03154881 -0.25864415  0.3503320857  0.001535501
#> gs4  0.18757533  0.26720274  0.07846442 -0.0003996428 -0.070926352
#> gs5 -0.17732782 -0.06065409 -0.09153496  0.0297413674  0.178300782
```
...
#> Unit: seconds
#>      expr       min        lq      mean    median        uq       max neval
#>      gsva 18.947972 18.952937 18.959342 18.957902 18.965027 18.972153     3
#>  bixverse  2.700417  2.704049  2.705883  2.707681  2.708616  2.709551     3
```
...
#>             s1          s2         s3         s4          s5
#> gs1 0.18811167  0.14186833 0.05994887 -0.0219137 -0.01379570
#> gs2 0.13025157  0.19949063 0.17841387  0.1755016  0.11050148
#> gs3 0.08643236 -0.09641431 0.18111269  0.2487600  0.33882967
#> gs4 0.12593852 -0.05170492 0.04995114  0.2325171  0.21727381
#> gs5 0.19484765  0.17477726 0.13855870  0.1483310  0.09148624
```
...
#> Unit: milliseconds
#>      expr      min       lq     mean   median       uq       max neval
#>      gsva 649.8664 661.9167 868.3688 673.9670 977.6199 1281.2729     3
#>  bixverse 102.1372 102.3128 102.4212 102.4884 102.5631  102.6379     3
```
...
#>     mitch 144.257405 148.461759 150.95955 148.677272 155.045206 158.356121
#>  bixverse   3.544252   3.553198   4.57137   3.563768   6.038581   6.157053
#>  neval
#>      5
#>      5
```
