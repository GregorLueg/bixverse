...
#>               s1          s2          s3          s4         s5
#> gs1 -0.143945633 -0.07389995  0.07054961  0.10618913 0.01654496
#> gs2 -0.153556280 -0.11321119 -0.07498454 -0.10721453 0.25404687
#> gs3  0.008648107  0.04148029 -0.13950750 -0.08704616 0.04021348
#> gs4 -0.102012588  0.05422384  0.11934669  0.07029373 0.01077136
#> gs5  0.200258385 -0.01739700  0.12739878 -0.08694565 0.07765142
```
...
#>      gsva 2818.1444 2824.7146 2835.6927 2831.2849 2844.4669 2857.6490     3
#>  bixverse  598.7163  599.0758  600.2023  599.4353  600.9453  602.4553     3
```
...
#>              s1          s2           s3          s4          s5
#> gs1 -0.20256287 -0.17332858  0.175003569  0.03391048 -0.16846241
#> gs2 -0.01816757 -0.29835969 -0.385450245 -0.15323090  0.03510566
#> gs3  0.11096990 -0.01514461  0.003291319  0.07709071 -0.08516096
#> gs4 -0.02927058  0.19835178 -0.009172546  0.29018790  0.07465485
#> gs5  0.21122884 -0.06373686 -0.073541778 -0.10754587 -0.13288930
```
...
#> Unit: seconds
#>      expr       min        lq      mean    median        uq       max neval
#>      gsva 19.280837 19.282123 19.285202 19.283409 19.287384 19.291359     3
#>  bixverse  2.881095  2.882461  2.885511  2.883827  2.887719  2.891611     3
```
...
#>             s1         s2         s3         s4        s5
#> gs1 0.14146552 0.01461476 0.09181471 0.22607908 0.1079288
#> gs2 0.01323652 0.09722255 0.03635321 0.02826081 0.3133522
#> gs3 0.08569690 0.14423791 0.02464421 0.07560117 0.1027682
#> gs4 0.08403218 0.13879972 0.16665918 0.15668187 0.1441631
#> gs5 0.18926367 0.12914756 0.21969150 0.04206844 0.1601198
```
...
#> Unit: milliseconds
#>      expr      min       lq     mean   median       uq      max neval
#>      gsva 630.1267 638.0389 641.3697 645.9511 646.9912 648.0312     3
#>  bixverse 114.6607 115.5975 115.9402 116.5344 116.5799 116.6255     3
```
...
#>     mitch 145.374486 147.640561 150.191350 149.243263 152.969196 155.729246
#>  bixverse   3.559197   3.641269   4.768661   3.829568   5.283477   7.529794
#>  neval
#>      5
#>      5
```
