...
#>   ..- attr(*, ".internal.selfref")=<pointer: 0x5611a0e5cb80> 
...
#> 1:      rna      pca   <NA>    TRUE  FALSE   <NA> a5ef33e6ce9d182f
#> 2:      rna      knn   <NA>    TRUE  FALSE   <NA> 92e3240f9c8f85bc
#> 3:      rna      snn   <NA>    TRUE  FALSE   <NA> 4de0a4a97b5bf5e2
#>                from
#>              <list>
#> 1:                 
#> 2: a5ef33e6ce9d182f
...
#>                                                         reason               id
#>                                                         <char>           <char>
#> 1:                                                        <NA> 91cbc376f5216bb7
#> 2: the artefact it was derived from was re-computed or removed 92e3240f9c8f85bc
#> 3:                             its upstream `rna:knn` is stale 4de0a4a97b5bf5e2
#>                from
#>              <list>
#> 1:                 
#> 2: a5ef33e6ce9d182f
...
#>    modality artefact   name stamped  stale reason               id
#>      <char>   <char> <char>  <lgcl> <lgcl> <char>           <char>
#> 1:      rna      pca   <NA>    TRUE  FALSE   <NA> 91cbc376f5216bb7
#> 2:      rna      knn   <NA>    TRUE  FALSE   <NA> 6dc8409bf73fc842
#> 3:      rna      snn   <NA>    TRUE  FALSE   <NA> 1bd0aa25f0d7cdfc
#>                from
#>              <list>
#> 1:                 
#> 2: 91cbc376f5216bb7
...
#>    the_correct_way 1.333509 1.378213 1.520308 1.418963 1.447272 2.491811    10
#>  the_incorrect_way 2.083770 2.279585 2.369278 2.409282 2.451325 2.605573    10
```
