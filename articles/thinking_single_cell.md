...
#>   ..- attr(*, ".internal.selfref")=<pointer: 0x55b9ca9d6b80> 
...
#> 1:      rna      pca   <NA>    TRUE  FALSE   <NA> 512a97d007f06c03
#> 2:      rna      knn   <NA>    TRUE  FALSE   <NA> 82e82bae31af1c17
#> 3:      rna      snn   <NA>    TRUE  FALSE   <NA> 3b88a8bee17e2752
#>                from
#>              <list>
#> 1:                 
#> 2: 512a97d007f06c03
...
#>                                                         reason               id
#>                                                         <char>           <char>
#> 1:                                                        <NA> 0a47456d38318038
#> 2: the artefact it was derived from was re-computed or removed 82e82bae31af1c17
#> 3:                             its upstream `rna:knn` is stale 3b88a8bee17e2752
#>                from
#>              <list>
#> 1:                 
#> 2: 512a97d007f06c03
...
#>    modality artefact   name stamped  stale reason               id
#>      <char>   <char> <char>  <lgcl> <lgcl> <char>           <char>
#> 1:      rna      pca   <NA>    TRUE  FALSE   <NA> 0a47456d38318038
#> 2:      rna      knn   <NA>    TRUE  FALSE   <NA> 9245241a3ff46f4f
#> 3:      rna      snn   <NA>    TRUE  FALSE   <NA> 114f95617dc008fc
#>                from
#>              <list>
#> 1:                 
#> 2: 0a47456d38318038
...
#>    the_correct_way 1.302089 1.310221 1.494839 1.351989 1.370090 2.845267    10
#>  the_incorrect_way 2.149525 2.255642 2.342160 2.398945 2.416391 2.425976    10
```
