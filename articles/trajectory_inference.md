...
embedding and draws the graph over them. A free layout of the abstracted
graph would put the nodes somewhere arbitrary, which you then have to
relate back to the UMAP by eye.
