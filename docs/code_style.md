...
S3/S4). To make key computations as fast as possible we use the [rextendr](https://github.com/extendr/rextendr) interface 
into Rust. </br>
...
should exist to use them. Please refer to the [Why Rust](/docs/why_rust.md)
