...
3. If the function does something beyond a 'simple' transformation, aggregation
   ...
   start with \_rs\_\_, and ideally an R wrapper should exist to use them. Please refer
   to the [Why Rust](/info/why_rust.md) section. While we are very keen on Rust, we
...
8. In terms of object-oriented programming, [S7](https://github.com/RConsortium/S7)
   ...
   go full blown into OOP. For smaller classes that do not warrant the usage
   of S7, just go with good old S3. You will see that there is quite a bit of
   usage of S3 classes in the single cell aspect, especially for classes 
