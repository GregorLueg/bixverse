...
As you can appreciate, the diffusions can be used to identify more "influenced"
parts of the network. If you want to transform the graphs into some embeddings
for visualisations, also check out [genewalkR](https://gregorlueg.github.io/genewalkR/)
which has very fast node2vec methods. 