...
numerical precision due to optimisations in Rust (approximation of the Gaussian CDF enabling). However, the correlations between the two are ≥0.99
...
# Parallelism only over 4 cores to avoid overheads here
