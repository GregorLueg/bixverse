...
and the
[introductory vignette](https://gregorlueg.github.io/bixverse/docs/articles/single_cell_intro.html),
...
We can pull the embeddings back into data.tables and plot them. The obs columns
