...
This vignette gives an overview of the different plotting functions that are available when running a single cell analysis. For more details on the data analysis itself, please refer to the
[introductory vignette](https://gregorlueg.github.io/bixverse/articles/thinking_single_cell.html). This vignette assumes familiarity with how the
...
We run the standard analysis using the same PBMC3k data set.
